...
contract WavePortal {
    ...
    function getUserWaves(address userAddress) public view returns (uint256) {
    	console.log("This address [%s] has %d total waves so far!", userAddress, userWaves[userAddress]);
    	return userWaves[userAddress];
    }
}